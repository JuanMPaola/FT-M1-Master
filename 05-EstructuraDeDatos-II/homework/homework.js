...
LinkedList.prototype.search = function (cb) {
  ...
  if(current.value === cb) return true;
  if(cb(current.value)=== true) return true;
...
HashTable.prototype.set =function (key, value){
  if (typeof key  !== "string") throw TypeError ("Keys must be strigns")
